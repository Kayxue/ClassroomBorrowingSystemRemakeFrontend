    ...
    <div className="container mx-auto px-20">
      {isLoading || swrLoading ? (
        ...
        <>
          <div className="h-16" />
          <div>
            <p className="text-lg md:text-5xl bg-clip-text bg-gradient-to-b from-neutral-200 to-neutral-600 text-center font-bold">{swrData.name}</p>
          </div>
          <div className="h-16" />
          <div className="flex">
          ...
          {!data ? null : <RecordList type={1} param={classroomId} />}
        </>
      )}
    </div>
  );
